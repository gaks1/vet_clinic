...
**[VET CLINIC DATABASE]** is a project showing the schema of a database, the data inserted and some queries to play around with.
...
Feel free to check the [issues page](https://github.com/gaks1/vet_clinic/issues).
